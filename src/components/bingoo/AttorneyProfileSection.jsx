...
function _Section({ title, children, icon: Icon, color = "#0b2149" }) {
  return (
...
export default function AttorneyProfileSection({ member, coverColor = "#0b2149" }) {
  ...
  const _allServices = cats.flatMap(_c => (member.practice_areas || "")
  ...
  return (
    <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-slate-100">
      ...
      <div className="px-5 pb-4 -mt-14">
        ...
        {/* Tabs */}
        {tabs.length > 1 && (
          <div className="w-full min-w-0 overflow-x-auto scrollbar-hide border-b border-slate-100 mb-4" style={{ WebkitOverflowScrolling: "touch" }}>
