import { ShoppingBag, Package, Settings, FileText, PackageCheck, ShieldCheck, LayoutDashboard } from "lucide-react";
...
const SECTIONS = [
  ...
  { id: "identity",  label: "Identity",  labelFr: "Identité",   itemIds: ["profiles", "qrwallet", "connections", "docwallet", "myassets", "quality"] },
